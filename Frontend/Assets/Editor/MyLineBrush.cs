...
namespace UnityEditor.Tilemaps
{
    ...
    [CustomGridBrush(true, false, false, "My Line Brush")]
    public class MyLineBrush : GridBrush
    {
        /// <summary>
        ...
        public int dotSpacing = 2; // Spacing between dots, adjust as needed
        ...
        public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            if (lineStartActive)
            {
                ...
                else
                {
                    ...
                    {
                        // Skip tiles based on dotSpacing to create a dotted line
    ...
    /// </summary>
    [CustomEditor(typeof(MyLineBrush))]
    public class LineBrushEditor : GridBrushEditor
    {
        private MyLineBrush lineBrush { get { return target as MyLineBrush; } }
        ...
        public override void OnPaintSceneGUI(GridLayout grid, GameObject brushTarget, BoundsInt position, GridBrushBase.Tool tool, bool executing)
        {
            ...
            if (lineBrush.lineStartActive && brushTarget != null)
            {
                ...
                {
                    foreach (var point in MyLineBrush.GetPointsOnLine(startPos, endPos, lineBrush.fillGaps))
                    {
                        Vector3Int paintPos = new Vector3Int(point.x, point.y, position.z);
