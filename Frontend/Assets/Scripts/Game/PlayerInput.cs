...
namespace Sludge.PlayerInputs
{
    public class PlayerInput
    {
        ...
        public bool JumpActive() => Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.J) || Input.GetKey(KeyCode.Space) || controllerJump;
        public bool BackActive() => Input.GetKey(KeyCode.Q) || Input.GetKey(KeyCode.Escape) || Input.GetKey(KeyCode.Backspace);
        public bool SelectActive() => Input.GetKey(KeyCode.E) || Input.GetKey(KeyCode.Return) || Input.GetKey(KeyCode.KeypadEnter);
